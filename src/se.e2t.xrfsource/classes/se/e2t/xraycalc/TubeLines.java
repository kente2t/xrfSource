...
public class TubeLines {
    ...
    private static final Map<Integer, LineInfo> K_ALPHA_12_LINE;
    ...
    private static final Map<Integer, LineInfo> K_BETA_1_LINE;
    ...
    private static final Map<Integer, LineInfo> L_ALPHA_12_LINE;
    ...
    private static final Map<Integer, LineInfo> M_ALPHA_12_LINE;
    ...
    private static final Map<Integer, LineInfo> L_ALPHA_1_LINE;
    ...
    private static final Map<Integer, LineInfo> L_ALPHA_2_LINE;
    ...
    private static final Map<Integer, LineInfo> L_BETA_2_LINE;
    ...
    private static final Map<Integer, LineInfo> L_IOTA_LINE;
    ...
    private static final Map<Integer, LineInfo> L_BETA_1_LINE;
    ...
    private static final Map<Integer, LineInfo> L_BETA_3_LINE;
    ...
    private static final Map<Integer, LineInfo> L_BETA_4_LINE;
    ...
    private static final Map<Integer, LineInfo> L_ETA_LINE;
    ...
    private static final Map<Integer, LineInfo> L_GAMMA_1_LINE;
    ...
    private static final Map<Integer, LineInfo> L_GAMMA_3_LINE;
    ...
    private static final Map<Integer, LineInfo> L_GAMMA_2_LINE;
    
    static {
        L_GAMMA_2_LINE = new HashMap<>();
    }  
    
    private static final Map<Integer, LineInfo> L_BETA_5_LINE;
    
    static {
        L_BETA_5_LINE = new HashMap<>();
    }  
    
   private static final Map<Integer, LineInfo> L_BETA_6_LINE;
    
    static {
        L_BETA_6_LINE = new HashMap<>();
    }    
    
    private static final Map<Lline, Map<Integer, LineInfo>> TUBE_L_LINE_INFO;

    static {
        TUBE_L_LINE_INFO = new HashMap<>();
        TUBE_L_LINE_INFO.put(Lline.L_ALPHA_1, L_ALPHA_1_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_ALPHA_2, L_ALPHA_2_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_BETA_2, L_BETA_2_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_IOTA, L_IOTA_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_BETA_1, L_BETA_1_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_BETA_3, L_BETA_3_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_BETA_4, L_BETA_4_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_ETA, L_ETA_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_GAMMA_1, L_GAMMA_1_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_GAMMA_3, L_GAMMA_3_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_GAMMA_2, L_GAMMA_2_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_BETA_5, L_BETA_5_LINE);
        TUBE_L_LINE_INFO.put(Lline.L_BETA_6, L_BETA_6_LINE);
    }
    
    
//    private static final Map<Integer, LineInfo> L_B1_LINE;
//
//    static {
//        L_B1_LINE = new HashMap<>();
//        L_B1_LINE.put(45, new LineInfo(2.8344d, 2.933d, 3.1447600d));
//        L_B1_LINE.put(74, new LineInfo(9.6726d, 7.6d, 11.5386000d));
//    }
//    ;
    ...
    public static class LineInfo {
        ...
        private final double _energy; //Energy in keV
        private final double _lineWidth; //Natural width in eV
        private final double _absorptionEdge; // Absorption edge in keV
    ...
    public static Map<XrfLine, Map<Integer, LineInfo>> getTUBE_LINE_INFO() {
        return TUBE_LINE_INFO;
    }
    
    public static LineInfo getLlineInfo(Lline line, int z) {
